...
def list_directories_and_files(path):
    """Lists only directories, only files, and all contents in the specified path."""
...
list_directories_and_files(r"C:\Users\Huawei\Desktop\Lecture\Labs\Lab6\dir-and-files.py")
